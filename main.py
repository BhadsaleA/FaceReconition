...
class Face_Recognition_system:
    def  __init__(self,root):
        ...
        # Student button 
        img4 = Image.open(r'images\person.png')
        img4 =img4.resize((180,180),Image.Resampling.LANCZOS)
        self.photoimg4=ImageTk.PhotoImage(img4)

        b1 = Button(bg_img,image=self.photoimg4,command=self.employee_detalis, cursor="hand2")
        b1.place(x=300,y=100,width=180,height=180)

        b1_1=Button(bg_img,text="Student details", command=self.employee_detalis, cursor="hand2",font=("times new roman", 20, "bold"), bg="blue", fg="white")
        b1_1.place(x=300,y=250,width=180,height=40)
        
        # Face Detection button
        img5 = Image.open(r'images\FaceDetect.jfif')
        ...
        b1_1.place(x=540,y=250,width=180,height=40)

        # Attendance button
        img6 = Image.open(r'images\attendance3.png')
        img6 =img6.resize((180,180),Image.Resampling.LANCZOS)
        self.photoimg6=ImageTk.PhotoImage(img6)

        b1 = Button(bg_img,image=self.photoimg6,cursor="hand2")
        b1.place(x=780,y=100,width=180,height=180)

        b1_1=Button(bg_img,text="Attendance", cursor="hand2",font=("times new roman", 20, "bold"), bg="blue", fg="white")
        b1_1.place(x=780,y=250,width=180,height=40)
        ...
        b1_1.place(x=1020,y=250,width=180,height=40)

        # Build button
        img8 = Image.open(r'images\build.png')
        img8 =img8.resize((180,180),Image.Resampling.LANCZOS)
        self.photoimg8=ImageTk.PhotoImage(img8)

        b1 = Button(bg_img,image=self.photoimg8,cursor="hand2")
        b1.place(x=300,y=350,width=180,height=180)
        ...
        # Photo button
        img9 = Image.open(r'images\cam.png')
        img9 =img9.resize((180,180),Image.Resampling.LANCZOS)
        self.photoimg9=ImageTk.PhotoImage(img9)

        b1 = Button(bg_img,image=self.photoimg9,cursor="hand2")
        b1.place(x=540,y=350,width=180,height=180)

        b1_1=Button(bg_img,text="Build", cursor="hand2",font=("times new roman", 20, "bold"), bg="blue", fg="white")
        b1_1.place(x=540,y=500,width=180,height=40)
        ...
        b1.place(x=780,y=350,width=180,height=180)

        b1_1=Button(bg_img,text="Build", cursor="hand2",font=("times new roman", 20, "bold"), bg="blue", fg="white")
        b1_1.place(x=780,y=500,width=180,height=40)
        
        # logout button
        img11 = Image.open(r'images\logout1.png')
        ...
        b1_1.place(x=1020,y=500,width=180,height=40)


##################### Button Function #########################
    def employee_detalis(self):
        self.new_window = Toplevel(self.root)
        self.app = EmployeeDetail(self.new_window)
